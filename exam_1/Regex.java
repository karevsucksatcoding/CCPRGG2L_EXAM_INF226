...
public class Regex {
    public static void main(String[] args) {
        ...
        pattern = Pattern.compile("(?=^[A-Za-z0-9_.]{10,}@)(?=[^@]*58)([^@]+)@gmail\\.com");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("^(https?:\\/\\/)?(www\\.)([A-Za-z0-9-.]*erol[A-Za-z0-9-.]*abuan[A-Za-z0-9-.]*)(\\.com)(\\.[A-Za-z]{2})?(\\/[A-Za-z0-9-.]*)?");
        ...
        // Provide regex pattern
        pattern = Pattern
                .compile("[A-Za-z0-9]*(\\.(pptx|xlsx|docx))");
